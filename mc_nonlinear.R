...
mean_non[1,]<-c(mean(b1_t),mean(b2_t),mean(b3_t),mean(b4_t))
b1_t
b2_t
b3_t
b4_t
...
b3_e
b4_e
mean_non[2,]<-c(mean(b1_e),mean(b2_e),mean(b3_e),mean(b4_e))
...
b3_u<-c()
b4_u<-c()
mean_non[3,]<-c(mean(b1_u),mean(b2_u),mean(b3_u),mean(b4_u))
...
p_b3
p_b4
mean_non[4,]<-c(mean(p_b1),mean(p_b2),mean(p_b3),mean(p_b4))
